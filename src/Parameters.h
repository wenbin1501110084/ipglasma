...
class Parameters {
  ...
  public:
    ...
    void setoutputV_only(int x) { outputV_only = x; }
    int getoutputV_only() {return outputV_only;}
    void setoutput_spectator_V(int x) {output_spectator_V = x;}
    int getoutput_spectator_V() {return output_spectator_V;}
};
#endif  // Parameters_H
