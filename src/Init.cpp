...
#pragma omp parallel
    {
        ...
        double localrapidityA = param->getRapidityA();
        double localrapidityB = param->getRapidityB();
        int check;
        QsA = 1;
        QsB = 1;
            ...
            for (int iy = 0; iy < N; iy++) {
                ...
                if (check == 2) {
                    if (param->getUseFluctuatingx() == 1) {
                        ...
                        lat->cells[localpos]->setg2mu2A(
                            getNuclearQs2(
                                lat->cells[localpos]->getTpA(), localrapidityA)
                        ...
                        lat->cells[localpos]->setg2mu2B(
                            getNuclearQs2(
                                lat->cells[localpos]->getTpB(), localrapidityB)
